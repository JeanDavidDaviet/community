 ...
 */
final class Version20210609151003 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__page AS SELECT id, slug, content, created_at, published_at, updated_at FROM page');
        $this->addSql('DROP TABLE page');
        $this->addSql('CREATE TABLE page (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, page_group_id INTEGER DEFAULT NULL, slug VARCHAR(255) NOT NULL COLLATE BINARY, content CLOB DEFAULT NULL COLLATE BINARY, created_at DATETIME NOT NULL, published_at DATETIME DEFAULT NULL, updated_at DATETIME NOT NULL, title VARCHAR(255) DEFAULT NULL, CONSTRAINT FK_140AB6207ECBDE67 FOREIGN KEY (page_group_id) REFERENCES page_group (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO page (id, slug, content, created_at, published_at, updated_at) SELECT id, slug, content, created_at, published_at, updated_at FROM __temp__page');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__page AS SELECT id, slug, content, created_at, published_at, updated_at FROM page');
        $this->addSql('DROP TABLE page');
        $this->addSql('CREATE TABLE page (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, slug VARCHAR(255) NOT NULL, content CLOB DEFAULT NULL, created_at DATETIME NOT NULL, published_at DATETIME DEFAULT NULL, updated_at DATETIME NOT NULL)');
        $this->addSql('INSERT INTO page (id, slug, content, created_at, published_at, updated_at) SELECT id, slug, content, created_at, published_at, updated_at FROM __temp__page');
        $this->addSql('DROP TABLE __temp__page');
        $this->addSql('DROP INDEX IDX_5A8A6C8DF675F31B');
        $this->addSql('CREATE TEMPORARY TABLE __temp__post AS SELECT id, author_id, content, created_at, updated_at FROM post');
