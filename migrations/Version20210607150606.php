 ...
 */
final class Version20210607150606 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__comment AS SELECT id, author_id, post_id, content, created_at, udpated_at FROM comment');
        ...
        $this->addSql('INSERT INTO comment (id, author_id, post_id, content, created_at, updated_at) SELECT id, author_id, post_id, content, created_at, udpated_at FROM __temp__comment');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP TABLE comment');
        $this->addSql('CREATE TABLE comment (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, author_id INTEGER DEFAULT NULL, post_id INTEGER NOT NULL, content CLOB NOT NULL, created_at DATETIME NOT NULL, udpated_at DATETIME DEFAULT NULL)');
        $this->addSql('INSERT INTO comment (id, author_id, post_id, content, created_at, udpated_at) SELECT id, author_id, post_id, content, created_at, updated_at FROM __temp__comment');
        $this->addSql('DROP TABLE __temp__comment');
        $this->addSql('CREATE INDEX IDX_9474526CF675F31B ON comment (author_id)');
        $this->addSql('CREATE INDEX IDX_9474526C4B89032C ON comment (post_id)');
        $this->addSql('DROP INDEX IDX_5A8A6C8DF675F31B');
